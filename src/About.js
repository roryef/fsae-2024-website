...
function About() {
  ...
  const eboard = [
    ...
    { name: 'Niya Zamyatina', title: 'Chief Mechanical Engineer', image: `${process.env.PUBLIC_URL}/headshots/Calvin.jpg` },
    ...
    { name: 'Karime Meija', title: 'Vehicle Dynamics Chief', image: `${process.env.PUBLIC_URL}/headshots/Karime.jpg` },
